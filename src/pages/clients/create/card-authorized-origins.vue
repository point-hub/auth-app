  ...
  <base-card>
    ...
    <div class="flex flex-col gap-4 my-5">
      <base-input layout="horizontal" border="full" required v-model="uri" label="URI" :disabled="isSaving"
        placeholder="https://www.example.com" @keyup.enter="addUri"
        :helpers="['The HTTP origins that host your web application. This value can\'t contain wildcards or paths. If you use a port other than 80, you must specify it.For example: https://example.com:8080']"
